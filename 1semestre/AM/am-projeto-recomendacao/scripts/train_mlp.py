...
def main():
    ...
    print(f"       Primeiras colunas: {list(X.columns[:5])}...")
        ...
        # --- 2. Criar o label (Y) --- 
        # como a popularidade ja vem do dataset, faço apenas a separação entre curtida e não curtida, utilizando a mediana como ponto de corte
        # aqui é a medida que o modelo pega pra validar se está acertando ou errando 
    ...
    y = y.iloc[:min_len]
        ...
        # é ideal seguir essa prática em projetos reais para ser mais definitivo sobre a performance do modelo em dados nunca vistos
