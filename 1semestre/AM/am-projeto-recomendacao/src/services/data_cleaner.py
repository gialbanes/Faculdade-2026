...
class DataCleaner:
    ...
    # analisa o dataframe e retorna um relatório detalhado sobre a qualidade dos dados
    def diagnose(self) -> dict:
        df = self.df
        report = {}

        # conta linhas, colunas e duplicatas
        ...
        # Detecção de Outliers (IQR) - avisa se existem valores muito fora da curva
        outliers_report = []
        ...
        # Estatísticas e correlações - verifica se músicas mais barulhentas tem mais energia e etc
        if numeric_cols:
