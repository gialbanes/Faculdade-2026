...
class MusicMLPClassifier:
    ...
    def __init__(self, model_dir: str | Path = "models"):
        ...
        self.model_path = self.model_dir / "mlp_model.joblib" # vai gerar esse aquivo de modelo treinado, não mexo mais nele a partir do momento que eu digo que ele está oK
    ...
    def train(
        ...
        hidden_layers: tuple = (64, 32), # camada oculta com 64 neurônios e outra camada oculta com 32 neurônios
        max_iter: int = 300,
        random_state: int = 42,
    ) -> "MusicMLPClassifier":
        ...
        self.model = MLPClassifier(
            ...
            activation="relu", # vals fixas que vou utilizar 
            solver="adam",
            early_stopping=True,
    ...
    def predict(self, X: np.ndarray | pd.DataFrame) -> dict:
        ...
        # como se o user for curtir ou não com base nos parâmetros que eu passar 
    ...
    # Para avaliar o modelo, a acurácia 
