...
public class CursosApi {
    ...
    public CursosApi(ApiClient apiClient) {
     ...
     */
    public List<Course> coursesGet() throws ApiException {
        ApiResponse<List<Course>> localVarResp = coursesGetWithHttpInfo();
     ...
     */
    public ApiResponse<List<Course>> coursesGetWithHttpInfo() throws ApiException {
    ...
    /**
     * Listar todos os cursos (asynchronously)
     * Retorna uma lista com todos os cursos disponíveis.
     ...
     */
    public okhttp3.Call coursesGetAsync(final ApiCallback<List<Course>> _callback) throws ApiException {
