...
fun Application.module() {
    ...
    val courseRepository: com.fatec.merge_skills.repository.CourseRepository
    val lessonRepository: com.fatec.merge_skills.repository.LessonRepository
    val questionRepository: com.fatec.merge_skills.repository.QuestionRepository

    if (useSupabase) {
        courseRepository = com.fatec.merge_skills.db.SupabaseCourseRepository()
        lessonRepository = com.fatec.merge_skills.db.SupabaseLessonRepository()
        questionRepository = com.fatec.merge_skills.db.SupabaseQuestionRepository()
